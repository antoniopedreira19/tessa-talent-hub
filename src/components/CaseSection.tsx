...
const CaseSection = () => {
  return (
    <section id="case" className="py-20 lg:py-32 bg-muted/30">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-card rounded-3xl p-8 lg:p-12 border border-border/50 shadow-xl relative overflow-hidden animate-fade-in">
