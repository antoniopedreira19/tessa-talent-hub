...
const ProblemSection = () => {
  return (
    <section className="py-20 lg:py-32 bg-muted/30 connection-pattern">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {problems.map((problem, index) => (
            <Card
              key={problem.title}
              className="group bg-card border-border/50 hover:border-accent/30 hover:shadow-lg transition-all duration-300 animate-slide-up"
